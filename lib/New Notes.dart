              ...
              children: [
                Container(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      ...
                      }, icon: const Icon(Icons.arrow_circle_left_rounded,size: 32,)),
                      ...
                      (widget.ind != null)
                          ? IconButton(onPressed: () {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Note Deleted"), padding: EdgeInsets.all(10),));
                        ...
                        if(widget.ind!=null)
                        ...
                        else
                          {
                            if(title.isEmpty ||subtitle.isEmpty)
                              {
                                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Filed Empty.")));
                              }
                            else
                              {
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      TextField(
                        controller: _title,cursorColor: Colors.black,
                      ...
                      TextField(
                        ...
                        maxLines: null,cursorColor: Colors.black,
                        decoration:InputDecoration(
                          border: InputBorder.none,contentPadding: const EdgeInsets.only(top: -8),
                          hintText: "Note",
